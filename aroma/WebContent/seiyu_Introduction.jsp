...
<title>精油紹介</title>
 <link rel="stylesheet" href="./seiyu_Introduction.css">
</head>
<div class="pinkbox">
    <h1>ラベンダー</h1>
</div>
...
<body>
<div class="layout">
<div class="lavenderpic">
<img src="Introduction_picture/lavenderpic.jpg" width="400" height="200" align="left" alt="lavender"/>
</div>
<div class="yellowbox">
    <h2>穏やかで心地よい、万能なフローラルハーブ</h2>
...
<div class="skin">
    <span class="box-title">肌への効能</span>
    <h5>やけどや傷の手当、湿疹や皮膚炎にも</h5>
    抗炎症作用や殺菌・消毒作用、癒傷作用
</div>
<div class="recomend">
    <h5>お勧めブレンド</h5>
